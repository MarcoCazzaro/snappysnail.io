...
Laravel 13 (PHP 8.2+) with Livewire 4, Jetstream, Tailwind CSS 4, Vite, and Alpine.js. MySQL database. Pest 4 for testing. Local dev runs via DDEV (`ddev artisan`, `ddev composer`, `ddev npm`).
...
ddev artisan pail          # real-time log viewer
...
ddev exec vendor/bin/pest tests/Unit/MyTest.php   # single test file
