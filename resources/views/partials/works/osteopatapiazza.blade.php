	...
	<div class="max-w-md mx-auto bg-white dark:bg-zinc-900 rounded-xl shadow-lg overflow-hidden md:max-w-2xl">
		<div class="md:flex">
			...
			<div class="p-8 text-justify">
				...
				<a href="https://osteopatapiazza.it/?who-made-this-website=snappy" class="block mt-1 text-lg leading-tight font-medium text-black dark:text-gray-300 hover:underline" target="_blank">Osteopatapiazza.it WordPress theme</a>
