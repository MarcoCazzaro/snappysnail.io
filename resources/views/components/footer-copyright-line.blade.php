...
<div class="flex gap-4 flex-wrap text-zinc-400 text-sm">
    ...
    <div class="{{ $element_bg }} flex gap-4 items-center justify-center">
        <a href="https://www.linkedin.com/in/marco-cazzaro-2b6373100/" class="ssnail-link" target="_blank"><i class="fab fa-linkedin"></i></a>
        <a href="https://github.com/MarcoCazzaro" class="ssnail-link" target="_blank"><i class="fab fa-github"></i></a>
    </div>
