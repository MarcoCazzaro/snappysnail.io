...
<div class="flex gap-4 flex-wrap text-black dark:text-white text-sm justify-center items-center">
    ...
    <div class="{{ $element_bg }} flex gap-4 items-center justify-center">
        <a aria-label="Linkedin profile page of Marco Cazzaro" href="https://www.linkedin.com/in/marco-cazzaro-2b6373100/" class="{{ $links_classes }}" target="_blank"><i class="fab fa-linkedin"></i></a>
